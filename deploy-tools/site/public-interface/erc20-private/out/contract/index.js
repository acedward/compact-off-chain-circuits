      ...
      name: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('name',
                                     ...
                                     'Interface.compact line 43 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      symbol: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('symbol',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 48 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      decimals: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('decimals',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 53 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      totalSupply: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('totalSupply',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 58 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      balanceOf: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('balanceOf',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 63 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      allowance: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('allowance',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 74 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = await this._allowance_0(context,
                                                 partialProofData,
                                                 owner_0,
                                                 spender_0);
        partialProofData.output = { value: _descriptor_4.toValue(result_0), alignment: _descriptor_4.alignment() };
    ...
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'FungibleToken: contract not initialized');
    const canonAcct_0 = account_0.is_left ?
                        { is_left: true,
                          left: account_0.left,
    ...
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'FungibleToken: contract not initialized');
    const canonOwner_0 = owner_0.is_left ?
                         { is_left: true,
                           left: owner_0.left,
                           right: { bytes: new Uint8Array(32) } }
                         :
                         { is_left: false,
                           left: new Uint8Array(32),
                           right: owner_0.right };
    const canonSpender_0 = spender_0.is_left ?
                           { is_left: true,
                             left: spender_0.left,
                             right: { bytes: new Uint8Array(32) } }
                           :
