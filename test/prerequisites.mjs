...
import { BUILD_HINT, COMPACT, COMPACT_HINT, PRIVATE_BUILD_HINT, hasCompact, isBuilt, isPrivateBuilt } from './helpers.mjs';
...
export default function setup() {
  ...
  if (built && !isPrivateBuilt()) console.log(`[prerequisites] private interface: MISSING — ${PRIVATE_BUILD_HINT}; its key, Level 3 and no-leak tests will be SKIPPED.`);
