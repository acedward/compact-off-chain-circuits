...
| | |
|---|---|
| URL | `https://compact-off-chain-circuits.pages.dev/registry-first/erc20/index.json` |
| Contract address | `721577875316525d6ef086e174d9bc3c8f0188f7fde73cd72a0bdbd310cf6ea7` |
...
```sh
node <compact-off-chain-circuits>/src/verify.mjs --bundle-url https://compact-off-chain-circuits.pages.dev/registry-first/erc20/index.json \
  --indexer https://indexer.stagenet.shielded.tools/api/v4/graphql --address 721577875316525d6ef086e174d9bc3c8f0188f7fde73cd72a0bdbd310cf6ea7 --circuit name --args ...
```
...
Add `--level 3` to recompile `src/examples/registry-first/Interface.compact` with compact
