...
| | |
|---|---|
| URL | `https://compact-off-chain-circuits.pages.dev/registry-first/erc20-metadata/index.json` |
...
```sh
node <compact-off-chain-circuits>/src/verify.mjs --bundle-url https://compact-off-chain-circuits.pages.dev/registry-first/erc20-metadata/index.json \
...
Add `--level 3` to recompile `src/live/stagenet/contracts/ERC20Metadata.RegistryFirst.Interface.compact` with compact
