...
class _InterfaceRef_0 {
  ...
  fromValue(value_0) {
    return {
      ...
      url: _descriptor_5.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.commitment).concat(_descriptor_5.toValue(value_0.url));
  }
}

const _descriptor_9 = new _InterfaceRef_0();
      ...
      name: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('name',
                                     ...
                                     'Interface.compact line 21 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      symbol: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('symbol',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 25 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      decimals: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('decimals',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 29 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      totalSupply: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('totalSupply',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 33 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      balanceOf: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('balanceOf',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 37 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      allowance: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('allowance',
                                     'argument 1 (as invoked from Typescript)',
                                     'Interface.compact line 41 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
...
export const expectedVk = {
  'allowance': 'e2f1ee798c0a4c1f264fa0929052ed519d6857d294c4089d9f6adedbccf50590',
