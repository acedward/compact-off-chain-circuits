...
```sh
node <compact-off-chain-circuits>/src/verify.mjs --bundle-url https://compact-off-chain-circuits.pages.dev/erc20/index.json \
  --indexer https://indexer.stagenet.shielded.tools/api/v4/graphql --address 294c2b6a9e405842294f9f273271047aa235654aaeb8dc4d6f44f5cd707cf913 --circuit name --args ...
```
